...
/**
 * The {@link SocketDynamicTableFactoryV2} translates the catalog table to a table source.
 *
...
public class SocketDynamicTableFactoryV2 implements DynamicTableSourceFactory {
    ...
    public String factoryIdentifier() {
        return "socketv2"; // used for matching to `connector = '...'`
    }
