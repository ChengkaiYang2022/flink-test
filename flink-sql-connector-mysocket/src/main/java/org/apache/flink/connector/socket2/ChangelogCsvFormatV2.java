...
/**
 * The {@link ChangelogCsvFormatV2} is a decoding format that uses a {@link DeserializationSchema}
 * during runtime. It supports emitting {@code INSERT} and {@code DELETE} changes.
 */
public final class ChangelogCsvFormatV2 implements DecodingFormat<DeserializationSchema<RowData>> {

    private final String columnDelimiter;

    public ChangelogCsvFormatV2(String columnDelimiter) {
    ...
    public DeserializationSchema<RowData> createRuntimeDecoder(
        ...
        return new ChangelogCsvDeserializerV2(
