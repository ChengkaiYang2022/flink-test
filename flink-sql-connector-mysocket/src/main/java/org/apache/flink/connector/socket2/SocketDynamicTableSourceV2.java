...
/**
 * The {@link SocketDynamicTableSourceV2} is used during planning.
 *
...
public class SocketDynamicTableSourceV2 implements ScanTableSource {
    ...
    public SocketDynamicTableSourceV2(
            String hostname,
            int port,
            byte byteDelimiter,
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext runtimeProviderContext) {
        ...
        final SourceFunction<RowData> sourceFunction =
                new SocketSourceFunctionV2(hostname, port, byteDelimiter, deserializer);
    ...
    public DynamicTableSource copy() {
        return new SocketDynamicTableSourceV2(
